...
import br.com.mmiiranda.a4chords.utils.UrlFormatter.formatArtistForApi
    ...
    fun searchArtist(artist: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                val artist_formater = formatArtistForApi(artist)
                val songs = repository.getSongsByArtist(artist_formater)
                Log.d("API_DEBUG", "songs: $songs")
